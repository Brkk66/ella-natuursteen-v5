...
import { Sparkles, Shield, Users, Award, LucideIcon } from "lucide-react";
...
const defaultFeatures = [
  {
    ...
    description: "Persoonlijk advies en op maat gemaakte oplossingen voor elk project.",
  },
  {
    icon: "shield",
    title: "Hoogwaardige Materialen",
    description: "Alleen de beste natuursteen, direct van gerenommeerde steenhouwerijen.",
  },
  {
    icon: "award",
    title: "Vakkundige Plaatsing",
    description: "Onze ervaren vakmensen zorgen voor een perfecte afwerking.",
  },
  {
    icon: "users",
    title: "Persoonlijk & Betrouwbaar",
    description: "Een familiebedrijf met persoonlijke aandacht en service.",
  },
];
...
export function WhyUs({
  subtitle = "Onze Belofte",
  title = "Waarom Ella Natuursteen?",
  description = "Ervaring, vakmanschap en passie voor natuursteen.",
            ...
            return (
              ...
              >
                ...
                <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 mb-4 sm:mb-6 bg-white rounded-full shadow-sm group-hover:shadow-md transition-shadow duration-300">
                  <IconComponent className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-gold" />
                </div>
