            ...
            {projects.map((project, index) => (
              ...
              >
                <Link href={project.href} className="group block">
                  ...
                  <div className="relative aspect-[3/4] rounded-t-[100px] rounded-b-2xl overflow-hidden shadow-xl mb-4">
                    <Image
                      src={project.image}
                      alt={project.title}
                      fill
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-stone-light">{project.location}</p>
                    </div>
                    <div className="w-10 h-10 rounded-full border border-stone/20 flex items-center justify-center group-hover:bg-gold group-hover:border-gold transition-all duration-300">
                      <ArrowRight className="w-4 h-4 text-stone group-hover:text-white transition-colors" />
                    </div>
                  </div>
                </Link>
              </motion.div>
