      ...
      <div className="container mx-auto px-5 sm:px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          >
            ...
            >
              <span className="block text-2xl sm:text-3xl font-serif">30+</span>
          ...
          >
            ...
            <div className="space-y-3 sm:space-y-4 text-stone-light text-sm sm:text-base leading-relaxed mb-6 sm:mb-8">
              <p>
                ...
                plaatsen van exclusief natuursteen.
              </p>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8 py-4 sm:py-6 border-y border-sand-dark">
              <div>
                <span className="block text-xl sm:text-2xl lg:text-3xl font-serif text-stone">500+</span>
                <span className="text-xs sm:text-sm text-stone-light">Projecten</span>
              </div>
              <div>
                <span className="block text-xl sm:text-2xl lg:text-3xl font-serif text-stone">100%</span>
                <span className="text-xs sm:text-sm text-stone-light">Maatwerk</span>
              </div>
              <div>
                <span className="block text-xl sm:text-2xl lg:text-3xl font-serif text-stone">5★</span>
                <span className="text-xs sm:text-sm text-stone-light">Reviews</span>
              </div>
            </div>
