...
const features = [
  ...
  "Uniforme kleur en textuur",
  "Hygiënisch en non-poreus",
  "Krasbestendig",
  "Grote kleurenkeuze",
  "10 jaar garantie",
];
...
interface ComposietContentProps {
  products: Product[];
}

export default function ComposietContent({ products }: ComposietContentProps) {
  return (
    <>
      <Navbar />
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <motion.h2 variants={fadeInUp} className="text-3xl sm:text-4xl font-serif text-stone mb-6">
                  De veelzijdigheid van composiet
                </motion.h2>
                <motion.p variants={fadeInUp} className="text-stone-light leading-relaxed mb-4">
                  Composiet combineert het beste van twee werelden: de schoonheid van natuurlijke materialen
                  met de praktische voordelen van moderne technologie.
                </motion.p>
                <motion.p variants={fadeInUp} className="text-stone-light leading-relaxed mb-6">
                  Bestaande uit circa 93% natuurlijk kwarts en 7% hars, biedt composiet een uitzonderlijke
                  hardheid en is het vrijwel onderhoudsvrij.
                </motion.p>
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-12 text-center">
            ...
            >
              <motion.h2 variants={fadeInUp} className="text-3xl sm:text-4xl font-serif mb-4">
                Bekijk onze composiet collectie
              </motion.h2>
              <motion.p variants={fadeInUp} className="text-white/70 mb-8 max-w-xl mx-auto">
                Ontdek alle kleuren en mogelijkheden in onze showroom.
              </motion.p>
