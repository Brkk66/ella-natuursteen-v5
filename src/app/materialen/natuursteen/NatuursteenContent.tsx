...
interface NatuursteenContentProps {
  products: Product[];
}

export default function NatuursteenContent({ products }: NatuursteenContentProps) {
  return (
    <>
      <Navbar />
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <motion.p variants={fadeInUp} className="text-stone-light leading-relaxed mb-4">
                  Natuursteen is al eeuwenlang het materiaal bij uitstek voor wie kiest voor kwaliteit en uitstraling.
                  Elk stuk is uniek, gevormd door de natuur over miljoenen jaren.
                </motion.p>
                <motion.p variants={fadeInUp} className="text-stone-light leading-relaxed mb-6">
                  Bij Ella Natuursteen werken wij uitsluitend met de beste steensoorten,
                  zorgvuldig geselecteerd bij gerenommeerde groeves wereldwijd.
                </motion.p>
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-12">
            ...
            >
              {[
                ...
                { name: "Vloeren", href: "/tegels/natuursteen" },
              ].map((item, index) => (
                <motion.div key={index} variants={fadeInUp}>
                  <Link
                    href={item.href}
                    className="block bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow text-center group"
                  >
                    <h3 className="text-lg font-serif text-stone group-hover:text-gold transition-colors">
                      {item.name}
                    </h3>
                  </Link>
                </motion.div>
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-12 text-center">
            ...
            >
              ...
              <motion.p variants={fadeInUp} className="text-white/70 mb-8 max-w-xl mx-auto">
                Kom langs en ervaar de schoonheid van natuursteen. Onze adviseurs helpen u graag bij uw keuze.
              </motion.p>
