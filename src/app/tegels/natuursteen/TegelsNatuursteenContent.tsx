...
export default function TegelsNatuursteenContent({ products }: Props) {
  return (
    <>
      <Navbar />
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <motion.p variants={fadeInUp} className="text-stone-light leading-relaxed mb-4">
                  Natuursteen tegels brengen de schoonheid van de natuur in uw interieur.
                  Elke tegel is uniek, gevormd door miljoenen jaren geologische processen.
                </motion.p>
                <motion.p variants={fadeInUp} className="text-stone-light leading-relaxed mb-6">
                  Of u nu kiest voor de warmte van travertin, de elegantie van marmer
                  of de robuustheid van leisteen - natuursteen geeft uw ruimte een tijdloze uitstraling.
                </motion.p>
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-12 text-center">
            ...
            >
              <motion.h2 variants={fadeInUp} className="text-3xl sm:text-4xl font-serif mb-4">
                Bekijk onze tegels in de showroom
              </motion.h2>
              <motion.p variants={fadeInUp} className="text-white/70 mb-8 max-w-xl mx-auto">
                Ervaar de schoonheid van natuursteen tegels. Onze adviseurs helpen u graag.
              </motion.p>
