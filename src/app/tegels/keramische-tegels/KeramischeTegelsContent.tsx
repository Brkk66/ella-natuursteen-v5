...
export default function KeramischeTegelsContent({ products }: Props) {
  return (
    <>
      <Navbar />
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                <motion.p variants={fadeInUp} className="text-gold uppercase tracking-[0.2em] text-sm mb-3">
                  Veelzijdig & praktisch
                </motion.p>
                <motion.h2 variants={fadeInUp} className="text-3xl sm:text-4xl font-serif text-stone mb-6">
                  Keramische tegels voor elk project
                </motion.h2>
                <motion.p variants={fadeInUp} className="text-stone-light leading-relaxed mb-4">
                  Keramische tegels combineren design met functionaliteit. Dankzij moderne productietechnieken
                  zijn ze verkrijgbaar in elke denkbare look - van beton tot marmer, van hout tot natuursteen.
                </motion.p>
                <motion.p variants={fadeInUp} className="text-stone-light leading-relaxed mb-6">
                  Onderhoudsvriendelijk, slijtvast en geschikt voor vloerverwarming.
                  De ideale keuze voor woonkamers, keukens, badkamers en terrassen.
                </motion.p>
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-12 text-center">
            ...
            >
              <motion.h2 variants={fadeInUp} className="text-3xl sm:text-4xl font-serif mb-4">
                Ontdek onze keramische tegels
              </motion.h2>
              <motion.p variants={fadeInUp} className="text-white/70 mb-8 max-w-xl mx-auto">
                Meer dan 1000 m² showroom vol inspiratie. Bezoek ons vrijblijvend.
              </motion.p>
